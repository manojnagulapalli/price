...
def predict(bedrooms,bathrooms,status
                       ,size,location,facing,Types):
    ...
    user_input = np.array([[bedrooms,bathrooms,selected_status
                       ,size,Selected_location,selected_facing,selected_type]])
